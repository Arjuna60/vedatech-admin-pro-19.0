...
public class InvoiceController {
    ...
    public InvoiceController(CfdiService cfdiService, CustomerDao customerDao, InvoiceDao invoiceDao) {
...
//            getInvoices(files);
            Invoice invoice = new Invoice();
            Comprobante comprobante = (Comprobante) cfdiService.contextFile(Comprobante.class, comprobanteFile);
            invoice.setFolio(comprobante.getFolio());
            invoice.setFecha(comprobante.getFecha().toGregorianCalendar());
            Integer paymentDay = cfdiService.convertToInteger(comprobante.getCondicionesDePago());
